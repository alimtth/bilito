      ...
      <div className="outline p-5 outline-gray-400 rounded-lg mt-7 mb-9  ">
        ...
        <div className="p-6 px-0 w-full gap-3 flex flex-col lg:flex lg:flex-row ">
          ...
          <div className="flex space-x-1">
            <div
              className="border border-gray-500 w-40 flex items-center px-4 rounded-r-lg justify-between"
              ...
              <div className="flex flex-wrap w-40 bg-white shadow-lg gap-2 py-2 rounded-lg px-3 absolute z-10 mt-14">
                {[...Array(30)].map((_, index) => (
                  <ul
                    key={index}
                    onClick={handleDay}
                    className={`w-4 h-8 flex-shrink-0 cursor-pointer ${
            ...
            <div className="border border-gray-500 w-40 flex items-center px-4 justify-between">
              ماه
              <IoIosArrowDown />
            </div>
            <div className="border border-gray-500 w-40 flex items-center px-4 rounded-l-lg justify-between">
              سال
              <IoIosArrowDown />
            </div>
          </div>
        ...
        <div className="p-6 px-0 w-full gap-3  flex flex-col lg:flex lg:flex-row">
          ...
          <InputTextField size={'sll'}>شماره یا پاسپورت</InputTextField>
          <div className="flex rounded-lg ">
            <div className="border border-gray-500 w-40 flex items-center px-4 rounded-r-lg justify-between">
              روز
              <IoIosArrowDown />
            </div>
            <div className="border border-gray-500 w-40 flex items-center px-4 justify-between">
