             ...
             <div className="fixed inset-0 flex items-center justify-center z-50">
                        <div className=" bg-white  w-[900px] rounded-lg  shadow-lg z-50 py-7 px-5">
                            ...
                            <div className="flex flex-col gap-8 mb-[334px]">
                                ...
                                <p>ساعت الزامی حضور: از 4 ساعت قبل پروزا حضور الزامی است و 1 ساعت قبل پرواز سیستمهای پذیرش مسافر بسته خواهند شد.</p>
                                <p>مسافران سیستمی بیزینس کلاس: مسافر که کلاس پروازی بیزینسی را انتخاب کردند می‌توانند به طور رایگان از سالن فرودگاه امام جهت پروازهای خروجی استفاده کنند</p>
                            </div>
