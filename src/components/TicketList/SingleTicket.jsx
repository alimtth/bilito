...
function SingleTicket({forth, back, imagess, price,flight_id, id, length, children, search,arrival,departure}) {
    ...
    const [priceTicket, setPrice] = useState(price);
    ...
    useEffect(() => {
        ...
        const formattedArrival = new Intl.DateTimeFormat('fa-IR', {
            hour: 'numeric',
            minute: 'numeric',
            hour12: false,
        }).format(dateArrival);
        setFormattedDateArrival(formattedArrival)
    ...
    return (
        <>
            <div className="flex border-gray-10 border rounded-lg flex-col gap-4 mt-6 justify-evenly  ">
                {isloding ? (
                    <div
                        className="flex w-[100%] h-[150px] mx-auto overflow-hidden bg-white rounded-lg shadow-lg animate-pulse  py-0">
                    ...
                    <div>
                        <div className="flex justify-between items-center px-4 lg:flex-row flex-col gap-4 py-6">
                            ...
                            <div className="flex justify-center items-center gap-[8px]">
                                <div
                                    className="bg-blue-100 text-blue-500  flex justify-center items-center gap-1 py-[2px] px-2 h-6 border rounded-md">
                                    اکونومی
                                </div>
                                <div
                                    className="bg-blue-100 text-blue-500  flex justify-center items-center gap-1 py-[2px] px-2 h-6 border rounded-md">
                        ...
                        <img src={line}/>
                            ...
                            <div className="flex lg:justify-center lg:items-end gap-6 items-center self-center">
                                <div className="text-blue-500">{priceTicket}</div>
                                <div>
