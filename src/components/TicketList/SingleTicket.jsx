...
function SingleTicket(props) {
    return (
        <div className='flex border-gray-10 border rounded-[8px] flex-col gap-[16px] mt-10 justify-evenly py-[24px]'>
            ...
            <div className='flex justify-between items-end gap-[64px] px-4'>
