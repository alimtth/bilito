...
function Input() {
    return (
            <div className='h-fit px-6 gap-2 rounded border border-gray-100 flex justify-between shrink-0 hover:shadow-xl hover:transition-shadow focus:border-blue-400 w-96 ' >
