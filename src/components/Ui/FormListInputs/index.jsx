    ...
    return (
        <>
            <div className='flex mt-10'>
                ...
                {/*<span className='basis-[40%]'>تاریخ تولد (شمسی)</span>*/}
            </div>
            <div className="px-0 w-full gap-3 flex flex-col lg:flex lg:flex-row items-end">
                <InputTextField size={'sll'}>نام لاتین</InputTextField>
                    ...
                    <div className={'flex'}>
                        <div className='relative border border-gray-500 w-40 px-4 rounded-r-lg'>
                            <div
                                ...
                                <input readOnly type={"text"} className='w-1/2 focus:outline-none caret-transparent' value={dayBirthValue}/>

                                <IoIosArrowDown/>
                            </div>
                            {dayDropdown && (
                                <div
                                    className="flex flex-wrap w-40 bg-white shadow-lg gap-2 py-2 rounded-lg px-3 absolute z-10 -mr-4">
                        ...
                        <div className='relative border border-gray-500 w-40 px-4'>
                            <div onClick={toggleDropdownMonth}
                                 className="flex items-center justify-between py-4">
                                <input readOnly type={"text"} className='w-1/2 focus:outline-none caret-transparent' value={monthValue}/>
                                <IoIosArrowDown/>
                            </div>
                            {monthDropdown && (
                                <div
                        ...
                        <div className='relative border border-gray-500 w-40 px-4 rounded-l-lg'>
                            <div onClick={toggleDropdownYear}
                                 className="flex items-center justify-between py-4">
                                <input readOnly type={"text"} className='w-1/2 focus:outline-none caret-transparent' value={yearValue}/>
                                <IoIosArrowDown/>
                            </div>
                            {yearDropdown && (
                                <div
            ...
            {/*    <div className={'basis-[40%]'}>تاریخ انقضا پاسپورت (شمسی)</div>*/}
            {/*</div>*/}
                    ...
                    <div className={'flex'}>
                        <div className='relative border border-gray-500 w-40 px-4 rounded-r-lg'>
                            <div
                                ...
                                <input className='w-1/2 focus:outline-none caret-transparent' value={expireDayValue}/>
                        ...
                        <div className='relative border border-gray-500 w-40 px-4'>
                            <div onClick={toggleDropdownExpireMonth}
                                 className="flex items-center justify-between py-4">
                                <input className='w-1/2 focus:outline-none caret-transparent' value={expireMonthValue}/>
                                <IoIosArrowDown/>
                            </div>
                            {expireMonthDropdown && (
                                <div
                        ...
                        <div className='relative border border-gray-500 w-40 px-4 rounded-l-lg'>
                            <div onClick={toggleDropdownExpireYear}
                                 className="flex items-center justify-between py-4">
                                <input className='w-1/2 focus:outline-none caret-transparent' value={expireYearValue}/>
                                <IoIosArrowDown/>
                            </div>
                            {expireYearDropdown && (
                                <div
