  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onFormSubmit)}>
        <div className="px-0 w-full gap-3 justify-center flex flex-col lg:flex lg:flex-row items-center">
          <InputTextField
            name="latin_name"
            size={'slx'}
            type="text"
          ...
          <div className="my-10 rounded-lg gap-2 flex flex-col items-center">
        ...
        <div className="my-7 pt-4 px-0 w-full gap-3 flex flex-col lg:flex lg:flex-row items-center justify-center">
        ...
        <div className="mt-10 flex flex-col rounded-lg gap-2 items-center">
