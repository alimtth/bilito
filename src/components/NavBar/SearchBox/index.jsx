...
function SearchBox() {
    ...
    // برا اینپوت مبدا و مقصد
    // const toggleDropdownOrigin=()=>{
    //   setToggle(true)
    // }
    ...
    //     // const result = searchInput(query)
                    ...
                    >
                        <div>
                            <ul className="flex justify-around gap-10 md:text-base sm:text-3xl ">
                                <li className={`flex gap-2 ${internationalFlights ? 'text-blue-500 font-bold' : ''}`}>
                                    <img src={`${internationalFlights ? AirplanSelected : AirplanNotSelected}`}
                                         className="md:block w-full h-full object-cover hidden"/>
                                    پروازخارجی
                                </li>
                                <li onClick={handleFlight}><FontAwesomeIcon icon={faArrowRightArrowLeft}/></li>
                                <li className={`flex gap-2 ${internationalFlights ? '' : 'text-blue-500 font-bold'}`}>
                                    <img src={`${internationalFlights ? AirplanNotSelected : AirplanSelected}`}
                                         className="md:block w-full h-full object-cover hidden"/>
